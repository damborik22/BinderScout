...
3. **Stability / QC** — is the binder a real, folded, stable protein?
   ...
   This is the in-vitro counterpart of the in-silico **monomer QC** (`binderscout-evaluator` `qc.md`)
...
- Pair with **monomer QC** (`binderscout-evaluator` `qc.md`): a context-dependent fold may express
