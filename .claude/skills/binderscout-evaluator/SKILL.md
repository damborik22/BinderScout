...
## 5. Handoff
→ `binderscout-wetlab` with the top candidates (ranked + affinity + QC).
...
- Sibling: `binderscout-orchestrator` (its `evaluation.md` is the seed for `pipeline.md`).
