...
Run this in the 'binder-eval-af3' conda environment on DGX Spark (aarch64).
...
def add_parser(subparsers) -> None:
    p = subparsers.add_parser(
        "refold-af3",
        help="Refold sequences with AlphaFold 3 (run in 'binder-eval-af3' conda env, aarch64 only).",
