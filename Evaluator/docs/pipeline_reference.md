...
## Repo Structure
```
<BM5_HOME>/Documents/BindMaster repo/
...
- **Path**: `<BM5_HOME>/BindMaster/mosaic/.venv`
- **Python**: 3.12, numpy 2.1.0, jax 0.9.0.1, equinox, mosaic package
- **binder-compare installed**: YES — `<BM5_HOME>/BindMaster/mosaic/.venv/bin/binder-compare`
...
<BM5_HOME>/BindMaster/mosaic/.venv/bin/binder-compare refold-boltz2 \
...
conda run -n bindcraft_pr binder-compare run \
    ...
    --boltz2-python <BM5_HOME>/BindMaster/mosaic/.venv/bin/python \
    -o ./comparison_report
```
...
- refold_Version6 AF2_DATA_DIR = `<BM5_HOME>/BindMaster/bindcraft-tools/af2_params` (NOT /home/.../bindcraft-tools/af2_params — note the BindMaster/ in path!)
